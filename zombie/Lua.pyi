...
from se.krka.kahlua.converter import JavaType, KahluaConverterManager
...
class LuaManager:
  ...
  class GlobalObject:
    ...
    @staticmethod
    def Render3DItem(item: InventoryItem, sq: IsoGridSquare, xoffset: float, yoffset: float, zoffset: float, rotation: float) -> None: ...
    
    @staticmethod
    def SyncXp(player: IsoPlayer) -> None: ...

    @staticmethod
    def addBloodSplat(sq: IsoGridSquare, nbr: int) -> None: ...

    @staticmethod
    def addSound(source: IsoObject, x: int, y: int, z: int, radius: int, volume: int) -> None: ...

    @staticmethod
    def addZombieSitting(x: int, y: int, z: int) -> None: ...

    @staticmethod
    def addZombiesEating(x: int, y: int, z: int, totalZombies: int, skeletonBody: bool) -> None: ...

    @staticmethod
    def addZombiesInBuilding(arg0: BuildingDef, totalZombies: int, outfit: str, room: RoomDef, femaleChance: Integer) -> ArrayList[IsoZombie]: ...

    @staticmethod
    def addZombiesInOutfitArea(x1: int, y1: int, x2: int, y2: int, z: int, totalZombies: int, outfit: str, femaleChance: Integer) -> ArrayList[IsoZombie]: ...

    @staticmethod
    def checkServerName(name: str) -> str: ...

    @staticmethod
    def getAverageFPS() -> Double: ...

    @staticmethod
    def getContainerOverlays() -> ContainerOverlays: ...

    @staticmethod
    def getTileOverlays() -> TileOverlays: ...

    @staticmethod
    def screenZoomIn() -> None: ...

    @staticmethod
    def screenZoomOut() -> None: ...

    @staticmethod
    def sendAddXp(player: IsoPlayer, perk: PerkFactory.Perk, amount: int) -> None: ...
